...
-- 1. Insert Suppliers
INSERT INTO supplier_master (supplier_name, contact_person, email, phone, address, rating, is_approved) VALUES 
('Global API Corp', 'John Smith', 'john@globalapi.com', '+1234567890', '123 API Ave', 4.8, TRUE),
('MediPack Solutions', 'Alice Jones', 'alice@medipack.com', '+0987654321', '456 Pack St', 4.5, TRUE)
...
('PM-001', 'Blister Pack Type A', 'PVC/Alu', 'MediPack Solutions', 'Packaging', 'N/A', 'Unscheduled', 'Room Temperature', 10000, TRUE, 'PACKAGING_MATERIAL', 'UNITS'),
