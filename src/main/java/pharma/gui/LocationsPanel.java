...
public class LocationsPanel extends JPanel {
    ...
    public LocationsPanel(JFrame mainFrame, DatabaseService dbService) {
        ...
        refreshBtn.addActionListener(e -> loadLocationData());

        // FIX 2: Correctly calling the common dialog entry point for ADDITION.
        addBtn.addActionListener(e -> openLocationDialog(null));
        ...
        deleteBtn.addActionListener(e -> handleDeleteLocation());
    }
    ...
    private void openLocationDialog(Location locationToEdit) {
        // FIX 3: Call the constructor of LocationDialog with the three correct
        // arguments:
    ...
    private void loadLocationData() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Error loading location data: " + ex.getMessage() + ". Check DatabaseService connection.",
                    "Database Error", JOptionPane.ERROR_MESSAGE);
        }
    }

    /**
     * Public method to refresh the location list, typically called by the dialog
    ...
    private void handleUpdateLocation() throws SQLException {
        ...
        if (selectedRow >= 0) {
            ...
            if (selectedLocation != null) {
                ...
                JOptionPane.showMessageDialog(this, "Error: Location not found in database.", "Database Error",
                        JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please select a location to update.", "No Selection",
    ...
    private void handleDeleteLocation() {
        ...
        if (selectedRow >= 0) {
            ...
            int confirm = JOptionPane.showConfirmDialog(this,
                    "Are you sure you want to delete location " + locationCode + "? This will affect linked inventory!",
                    "Confirm Deletion", JOptionPane.YES_NO_OPTION);

            if (confirm == JOptionPane.YES_OPTION) {
                if (dbService.deleteLocation(locationCode)) {
                    JOptionPane.showMessageDialog(this, "Location deleted successfully.", "Success",
                            JOptionPane.INFORMATION_MESSAGE);
                    loadLocationData();
                } else {
                    JOptionPane.showMessageDialog(this,
                            "Error deleting location. It may be linked to existing inventory records.",
                            "Database Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please select a location to delete.", "No Selection",
                    JOptionPane.WARNING_MESSAGE);
        }
    }
}
